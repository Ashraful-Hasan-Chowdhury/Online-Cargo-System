...
<div class="card component-card_1 mt-4" style="width: 1000px;">
    <div class="card-body">
        ...
        <div class="col-lg-6 col-12 mx-auto">
            <form method="post" action="{{ route('insert.truck') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input id="t-text" type="text" name="licence_no" placeholder="Licence No." class="form-control"
                        required>
