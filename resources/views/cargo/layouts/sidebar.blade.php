    ...
    <nav id="sidebar">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="index-2.html" class="nav-link">Cargo</a>
            </li>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('add.truck') }}"> Add Truck </a>
                    </li>
                    <li>
                        <a href="{{ route('show.truck') }}"> View Trucks </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu2" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('show.drivers') }}"> Driver Requests </a>
                    </li>
                    <li>
                        <a href="{{ route('drivers.list') }}"> Manage Drivers </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu3" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('add.goods') }}"> Add Goods </a>
                    </li>
                    <li>
                        <a href="{{ route('show.goods') }}"> View Goods </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu4" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('add.cities') }}"> Add City </a>
                    </li>
                    <li>
                        <a href="{{ route('show.cities') }}"> View Cities </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu5" data-parent="#accordionExample">
                    <li>
                        <a href="{{ route('add.prices') }}"> Add Pricing </a>
                    </li>
                    <li>
                        <a href="{{ route('show.prices') }}"> View Pricing </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu6" data-parent="#accordionExample">
                    <li>
                        <a href="javascript:void(0);"> Warehouse Requests </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"> Manage Warehouses </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="submenu7" data-parent="#accordionExample">
                    <li>
                        <a href="javascript:void(0);"> Order Requests </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"> Order List </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"> Canceled Orders </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"> Pending Orders </a>
                    </li>
                </ul>
            </li>
            <li class="menu">
