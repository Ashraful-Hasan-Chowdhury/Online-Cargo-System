...
<div class="card component-card_1 mt-4" style="width: 1000px;">
    <div class="card-body">
        ...
        <div class="col-lg-6 col-12 mx-auto">
            ...
            <form method="post" action="{{ route('driver.request.approve',$driver->id) }}">
                @csrf
                <div class="form-group">
                ...
                <input type="submit" value="approve" class="mt-4 btn btn-success">
                <a href="{{ route('driver.request.decline',$driver->id) }}" class="mt-4 btn btn-danger">decline</a>
            </form>
